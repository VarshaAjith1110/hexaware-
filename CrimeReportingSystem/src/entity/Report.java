...
public class Report {
    ...
    public Report(int reportID, int incidentID, int reportingOfficer, Date reportDate,
    ...
    public int getReportingOfficer() { return reportingOfficer; }
    public void setReportingOfficer(int reportingOfficer) { this.reportingOfficer = reportingOfficer; }
